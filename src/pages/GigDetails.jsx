...
//       {/* FREELANCER → PLACE BID (ONLY IF GIG IS OPEN) */}
...
//       {/* CLIENT (OWNER) → VIEW & HIRE BIDS */}
//       {user?.role === "client" && gig.ownerId === user.id && (
//         <>
//           <h3 style={{ marginTop: 30 }}>Bids Received</h3>
